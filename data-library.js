...
export const LIBRARY = [
  ...
  { id: "discovery-check", group: "scenes", title: "The Discovery Check", cite: "GME2e",
    body: "For when forward momentum has stalled and you are out of ideas - your character does something that gives a discovery a chance to happen, and you ask whether something is discovered at odds of no less than 50/50. The answer does more than decide yes or no. A Yes rolls once on the Thread Discovery Check table; an Exceptional Yes rolls twice and combines the results; a No finds nothing; and an Exceptional No finds nothing AND shuts Discovery down for the rest of the scene - a dead end your character has to leave and come back to later. When you do roll, it is 1d10 plus your current progress points: 9 or less is Progress +2, 10 is a Flashpoint +2, 15-17 is Progress +3, 18 is a Flashpoint +3. The other four all award points too: Track +1 and +2 mean you discovered nothing useful, but the act of trying moved you 1 or 2 points along anyway, and Strengthen Progress +1 and +2 mean earlier progress was reinforced - read it as a discovery that ties back into one you already made. A successful check is itself a random event, with this table standing in for the Event Focus table, so roll meaning words and read the result the way you would read any event." },

  { id: "progress-track", group: "scenes", title: "The Thread Progress Track", cite: "GME2e",
    body: "Pick one active thread as your focus and give it a track of 10, 15 or 20 points. It is a copy, not a move - the thread stays on the list and random events can still call on it. Making any progress toward it in a scene is worth 2 points, and so is a flashpoint, a dramatic event directly involving it; a moment can be both, and you choose which to call it. The track runs in phases of 5 points, each asking whether a flashpoint happened in it. If one has not by the time you cross out of a phase, the track makes one happen: a random event with an automatic focus of Current Context, involving the thread dramatically without resolving it. Cross that threshold mid-scene and it fires there and then; cross it during bookkeeping and it lands at the start of the next scene. Until the track fills, the thread carries plot armour - it cannot be resolved however close things look, and that covers a random event whose focus is Close A Thread, which plays out but does not actually close it. Fill the track and you get the Conclusion: a flashpoint with the armour off. If it fits the scene that triggered it, it happens there; if not it waits for the next scene, which you imagine with the conclusion in it and do NOT test against the Chaos Factor - the track guarantees that one begins as you pictured it. The Discovery Check, for when progress stalls, has its own entry." },

  { id: "chaos-variants", group: "scenes", title: "Other ways to run chaos", cite: "GME2e",
    body: "Three of the four change how hard chaos leans on a question, and each has its own printed Fate Chart. The standard chart gives every Chaos Factor its own column, so chaos swings a 50/50 question between a 10% Yes and a 90% one. Mid-Chaos groups the nine into five columns (1, 2-3, 4-6, 7-8, 9) and Low-Chaos into three (1-2, 3-7, 8-9), narrowing that swing; No-Chaos has a single column, so the odds alone decide. Under all three the Chaos Factor keeps moving in the background, because scenes are still tested against it and random events still trigger. The fourth, Random Chaos, changes who decides rather than how much: at the end of a scene roll a d10, and equal-or-under drops the Chaos Factor by one while over raises it. On the Fate Check the same compression arrives as smaller modifiers instead - Mid-Chaos runs +2 to -2, Low-Chaos +1 to -1." },
  ...
  { id: "fate-check", group: "oracle", title: "The Fate Check", cite: "GME2e",
    body: "An alternative to the chart, not an addition to it: roll 2d10 and add them, then add the odds modifier (Certain +5 down to Impossible -5) and the Chaos Factor modifier (+5 at chaos 9 down to -5 at chaos 1). Eleven or more is a Yes, eighteen or more an Exceptional Yes; ten or less is a No, four or less an Exceptional No. If both dice match and that number is at or under the Chaos Factor, you also get a random event - which means a double 10 never fires one, because chaos stops at nine." },
