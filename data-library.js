...
export const LIBRARY = [
  ...
  { id: "discovery-check", group: "scenes", title: "The Discovery Check", cite: "GME2e",
    body: "For when forward momentum has stalled and you are out of ideas - your character does something that gives a discovery a chance to happen, and you ask whether something is discovered at odds of no less than 50/50. On a Yes, roll 1d10 and add your current progress points: 9 or less is Progress +2, 10 is a Flashpoint +2, 15-17 is Progress +3, 18 is a Flashpoint +3. The other results - Track +1, Track +2, Strengthen Progress +1 and +2 - are printed in the table with no stated effect in what this app was built from, so the app rolls them, names them, and applies nothing." },
  ...
  { id: "chaos-variants", group: "scenes", title: "Other ways to run chaos", cite: "GME2e",
    body: "No-Chaos takes the Chaos Factor out of your questions entirely: answers come from the odds alone, while chaos keeps running underneath because scenes are still tested against it. Random Chaos takes the judgement out of your hands: at the end of a scene roll a d10, and equal-or-under drops the Chaos Factor by one while over raises it. Mid-Chaos trims the extremes - chaos pulls a question by +2 to -2 instead of +5 to -5 - and it is offered on the Fate Check, where the book's modifiers are known. The book also has a Mid-Chaos Fate Chart, but its cells were not in what this app was built from, so the app does not offer Mid-Chaos there rather than guessing at the columns." },
